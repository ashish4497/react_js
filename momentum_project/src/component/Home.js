      ...
      <div>
        <Header />
          <section className="image_section">
            ...
            <button className="learn-btn button">learnmore</button>
          </section>
         ...
         <section className="main_section">
            ...
            <div className="right-paragtaph-section right-col">
              ...
              <div className="paragraph-image-4 right-col">
               <img src={camera} classname="main-image-paragraph-4"></img>
                ...
                <button className="img-paragraph-btn-4 color-btn">learn more</button>
              </div>
            </div>
          </section>
          <section className="sub_section">
            <div className="left-col">
              <img src={camera} className="left-image"></img>
            </div>
